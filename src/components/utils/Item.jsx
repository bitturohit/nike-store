...
import { addItemToCart, toggleCart } from '../../store';

const Item = ({
  ifExists,
  item: { id, title, text, rating, btn, img, price, color, shadow },
}) => {
        ...
        >
          <img
            ...
            className={`transitions-theme hover:-rotate-12 ${
              ifExists
                ? 'h-auto w-64 lg:w-56 md:w-48 -rotate-[22deg] sm:-rotate-[35deg]'
                : 'h-36 w-64'
            }`}
          />
        </div>
